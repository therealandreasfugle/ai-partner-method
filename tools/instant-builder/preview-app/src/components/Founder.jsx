      ...
      <div className="relative max-w-7xl mx-auto px-8 pt-16 pb-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="relative" style={{ maxWidth: 480 }}>
            ...
            >
              {/* Years in business is never invented, so it is often blank. An
                  empty gold badge reads as a broken page, so when there is no
                  number the badge carries the label alone. */}
              {brandDNA.team.founder.yearsExp ? (
                <>
                ...
                <div className="font-heading font-bold uppercase tracking-wide leading-tight text-center" style={{ fontSize: 15, maxWidth: 150 }}>
                  {brandDNA.team.founder.expLabel}
                </div>
              )}
            </div>
