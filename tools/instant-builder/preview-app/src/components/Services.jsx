...
import { A, logoSrc } from '../config/asset-base'
...
const firstProjectImage = () => {
  ...
  if (candidate && candidate.filename) return A + `/work/${candidate.filename}`;
  return null;
};
    ...
    <section className="relative overflow-hidden bg-navy">
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="px-8 pt-8 pb-4 flex flex-col justify-center">
          <div className="mb-4">
            {logoSrc() && <img src={logoSrc()} alt={brandDNA.company.name} className="w-44 h-auto" />}
          </div>
