  ...
  return (
    <section className="relative overflow-hidden bg-grid bg-navy-slate">
      ...
      <div className="lg:hidden relative h-52 overflow-hidden">
        <img
          src={A + `/work/${(brandDNA.previous_projects && brandDNA.previous_projects[2] && brandDNA.previous_projects[2].filename) || (brandDNA.previous_projects && brandDNA.previous_projects[0] && brandDNA.previous_projects[0].filename) || 'project1.webp'}`}
          alt={`${brandDNA.company.name} completed project in ${brandDNA.address.city}`}
          className="w-full h-full object-cover"
          style={{ objectPosition: '50% 20%' }}
          onError={(e) => { e.target.onerror = null; e.target.src = A + '/hero-image.webp'; }}
        />
